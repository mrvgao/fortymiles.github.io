...
(function(d, c) {
    ...
    var b = MathJax.Extension.Safe = {
        ...
        filterClass: function(g) {
            if (e.classes === "none" || (e.classes !== "all" && !g.match(/^MJX-[-a-zA-Z0-9_.]+$/))) {
                g = null
            }
            return g
        },
        filterID: function(g) {
            if (e.cssIDs === "none" || (e.cssIDs !== "all" && !g.match(/^MJX-[-a-zA-Z0-9_.]+$/))) {
                g = null
            }
            return g
        },
        filterStyles: function(j) {
            if (e.styles === "all") {
                return j
            }
            if (e.styles === "none") {
        ...
        filterStyle: function(g, h) {
            ...
            if (h.match(/^\s*expression/)) {
                return null
            }
            if (h.match(/javascript:/)) {
                return null
            }
            return ( a.safeStyles[g] ? h : null)
        },
        ...
        filterRequire: function(g) {
            if (e.require === "none" || (e.require !== "all" && !a.safeRequire[g.toLowerCase()])) {
                g = null
            }
            return g
        }
    ...
    d.Register.StartupHook("TeX Jax Ready", function() {
        ...
        h.Augment({
            Require: function(j) {
                var k = this.GetArgument(j).replace(/.*\//, "").replace(/[^a-z0-9_.-]/ig, "");
                k = b.filterRequire(k);
                if (k) {
            ...
            SetSize: function(j, k) {
                ...
                if (k) {
                    ...
                    this.Push(i.Stack.Item.style().With({
                        styles: {
                            mathsize: k + "em"
                        }
                    }))
